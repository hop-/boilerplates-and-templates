...
_default: _printInfo _makeODir $(execable)
	@echo -e "$(GREEN)Compiled.$(RCOLOR)"

.PHONY: install debug noassert clean resolve
...
_printInfo:
	...
	@echo -e "$(BLUE)For more info run $(MAGENTA)'make help'"
	@echo ""
_makeODir:
	@mkdir -p $(OBJ_DIR)
resolve:
...
$(execable): $(OBJS)
	...
	@$(CXX) $(INCLUDES) $(CXXFLAGS) $(DEF_FLAGS) $(OBJS) -o $@ $(LIBS)
clean:
	@rm -rf $(OBJ_DIR)
	@rm -rf $(execable)
